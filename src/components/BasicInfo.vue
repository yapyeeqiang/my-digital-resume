<template>
    <div>
        ...
        <ul class="flex space-x-4">
            <li>
                <svg class="w-4 h-4 text-gray-500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                    <path
                        fill="currentColor"
